...
**릴리즈 주기를 고려한 신뢰성 관리란 두 가지를 고려해야 함**:

- 사용자가 인지할 수 있는 문제를 어느 정도까지 허용할 것인가?
- 테스트 커버리지를 어느 범위까지 설정할 것인가?

→ **기능 별**로, 혹은 **팀 별**로 신뢰성의 수준을 나누는 편이 나음

- 엔지니어링 팀은 목표 **릴리즈 주기에 맞게 불확실성 수준을 관리**해야 함.
- SRE 팀은 별도로 **불확실성 수준을 정의하여 릴리즈 비율을 극대화**해야 함.
