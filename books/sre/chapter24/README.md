...
<br/><img src="./img/figure24-1.png" width="80%" /><br/>
...
<br/><img src="./img/figure24-2.png" width="80%" /><br/>
...
**두 가지 Paxos 문제**
1. 로그를 무한정 기록할 수는 없으므로 로그 자체의 크기가 작아야 함 
2. 로그를 다른 어딘가에 저장 해야 함
...
**데이터 저장 방법**
1. 분산 저장소에 외부 저장
2. 크론 서비스 자체에 상태를 저장하는 저장소를 추가하는 방법
...
<br/><img src="./img/figure24-3.png" width="80%" /><br/>
