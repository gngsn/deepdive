...
<br><img src="./img/equation21-1.png" width="70%" />
...
<br><img src="./img/figure21-1.png" width="70%" />
...
> Example. **RPC 프로토콜**
> RPC 프로토콜은 정기적인 상태 점검 수행. 헬스 체크를 위한 상태 점검을 위한 UDP 연결. 하지만, 연결 상태 점검이 실제 요청을 처리하기 위해 필요한 자원보다 더 많은 자원을 소비할 수 있기 때문에 문제가 될 수 있음.
